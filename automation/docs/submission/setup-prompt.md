...
1. Install the workflow CLI.
   ...
   cd ~/hackathon-2026-09-19/auth-broker && npm install && PLAYWRIGHT_BROWSERS_PATH=0 npx playwright install chromium chromium-headless-shell
   export PATH="$HOME/hackathon-2026-09-19/openemr-cli:$PATH"
